#ifndef __THM3070_H__
#define __THM3070_H__   
...
extern void thm3070_Init(void);
extern void thm3070_open_RF(void);
extern void thm3070_close_RF(void);
extern void thm3070_send_buff(u8 *buffer,u16 num);
extern u16 thm3070_read_buff(u8 *buffer);
